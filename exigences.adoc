...
[[corde]]
:mycaption: Un exemple d'exigence en SysML (source <<SysML>>, p. 159)
ifndef::slides[.{mycaption}]
...
:mycaption: Relations liées aux exigences dans TOPCASED
ifndef::slides[.{mycaption}]
image::topcased-req-connections.png[width=30%]
ifdef::slides[[detail]#{mycaption}#]
