...
include::/Users/bruel/Dropbox/dev/definitions.txt[]
...
- Choisissez dans la liste des sous-sytèmes que nous avons listé https://docs.google.com/spreadsheets/d/1-yaW8fZHG9i6r7vJ7NOU9-66-hnDYY66Vd9cmZTYs2A/edit?usp=sharing[ici] celui qui vous inspire
