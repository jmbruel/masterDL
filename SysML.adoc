...
Les exigences et leur prises en compte sont un élément critique pour le
...
ifndef::slides[.Les 9 diagrammes SysML et leur lien avec UML]
ifdef::book[image::Figure4-1.png[scale=40]]
ifndef::book[image::Figure4-1.png[width=100%]]
...
ifndef::slides[.Version abrégée des diagrammes]
ifdef::book[image::Figure4-1-bis.png[scale=50]]
ifndef::book[image::Figure4-1-bis.png[width=100%]]
...
ifdef::slides[]
image::dessin-slide.jpeg[width=100%]
endif::slides[]
...
ifndef::slides[.Exemple de diagramme SysML]
...
ifndef::slides[.Exemple d'organisation simple]
ifdef::book[image::pkg-organisation2.png[scale=40]]
ifndef::book[image::pkg-organisation2.png[width="80%"]]

ifdef::slides[=== Les organisations possibles (suite)]

ifndef::slides[.Représentation de cette organisation dans un outil]
ifdef::book[image::pkg-organisation-modelview.png[scale=50]]
ifndef::book[image::pkg-organisation-modelview.png[width="60%"]]

ifdef::slides[=== Les organisations possibles (suite)]

ifndef::book[]
ifndef::slides[.Un autre exemple d'organisation]
image::pkg-organisation.png[width="60%"]
endif::book[]
...
ifndef::book[image::pkg-topcased.png[width="60%"]]
...
ifndef::book[image:modelio3.8SysML/organisation.png[width="50%"]]
...
ifdef::slides[=== Les dépendances (suite)]
